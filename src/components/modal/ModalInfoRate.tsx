...
function ModalInfoRate( props: ModalProps ) {
    ...
    return ( 
        <Modal 
            ...
            onCancel={onCancel} 
            footer={null}
            style={{ top: 5, overflowY: "auto", maxHeight: 'calc(100vh - 170px)', borderRadius: '8px' }}
            title='Đánh giá'
        ...
        >
            ...
            <table className="mb-5">
                ...
                <tbody>
                    {scoringRules.map(_rule => (
                        <tr className={_rule.level % 2 === 1 ? 'bg-[#DEEAF6]' : 'border-solid border-y-[1px] border-[#9CC2E5]'}>
            ...
            <table>
                <thead className="text-white text-center bg-[#5472BE] text-lg font-bold">
                    <tr>
                        <td className="p-2.5">Đóng góp cho thủ tục pháp luật</td>
