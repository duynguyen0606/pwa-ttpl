    ...
    >
      <div className=' relative'>
        ...
        <div className='bg-[#4755D4] mb-[70px]'>
          ...
          >
            {/* Law QA */}
            <Link href='/mobile/cau-hoi/' className='flex items-center mb-5'>
              <img src='https://ttpl.vn/assets/images/mobile/question.png' />
              <div className='ml-5'>Hỏi đáp pháp luật</div>
            </Link>

            {/* Các gói dịch vụ */}
            <Link href='/mobile/premium' className='flex items-center mb-5'>
        ...
        >
          ...
          <div className='flex items-center mb-5'>
            ...
            <span className='ml-5 text-base '>Công ty TNHH Legalzone</span>
          </div>
          ...
          <div className='flex items-center mb-3'>
            ...
            <span className='ml-5 text-xs'>
              Phòng 1603, Sảnh A3, Toà nhà Ecolife, 58 Tố Hữu, Trung Văn, Nam Từ
              Liêm, Hà Nội
            </span>
          </div>
        ...
        {/* Review modal */}
        <ModalReview open={showReview} onCancel={() => setShowReview(false)} />
      </div>
    </Drawer>
  );
}
