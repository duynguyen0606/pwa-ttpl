      ...
      {tabChildActive === 1 ? (
        <>
          {data && (
            <>
              <div className='p-4'>
                <div className='flex items-center py-2 gap-2 border-b border-slate-300'>
                ...
                <div className='flex items-center py-2 gap-2 border-b border-slate-300'>
                  ...
                  <span
                    dangerouslySetInnerHTML={{ __html: data.settlement_term }}
                  />
                </div>
                <div className='flex items-center py-2 gap-2 border-b border-slate-300'>
                  <div className='font-semibold min-w-40'>Biểu mẫu: </div>
                ...
                <div className='flex items-center py-2 gap-2 border-b border-slate-300'>
                  ...
                  <div
                    dangerouslySetInnerHTML={{ __html: data.legal_grounds }}
                  />
                </div>
              </div>
            </>
        ...
        <div
          className='p-4'
          dangerouslySetInnerHTML={{ __html: data.the_order_execution }}
        />
      )}
      <div className='flex items-center py-2 gap-2 border-b border-slate-300 p-4 m-4'>
