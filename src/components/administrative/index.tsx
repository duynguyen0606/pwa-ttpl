...
import Procedures from './procedures/page';
import PostManagement from './post-manage/page';
import CustomerManagement from './customer-manage/page';
import EmployeeManagement from './employee-manage/page';
import WoringFlow from './working-flow/page';
import Finance from './finance/page';
import CustomerSupport from './customer-support/page';
import WorkDay from './work-day/page';
import LeaveDay from './leave-day/page';
