...
function LawyerInfomation() {
  ...
  const CustomEditor = dynamic(() => import('../../common/customer-editor'), {
    ssr: false,
  });
  ...
  return (
    <div className='pb-10'>
      ...
      <div className='my-4 p-4 bg-white rounded-lg'>
        <div className='flex flex-col'>
          <div className='w-full flex justify-between'>
            <Typography.Title level={4}>Giới thiệu về Luật sư</Typography.Title>
            <Button
              type='text'
              icon={
                <Image
      ...
      <div className='my-4 p-4 bg-white rounded-lg'>
        <div className='w-full flex justify-between'>
          <Typography.Title level={4}>Hình ảnh và video</Typography.Title>
          <Button
            type='text'
            icon={
              <Image
      ...
      <div className='my-4 p-4 bg-white rounded-lg'>
        <Typography.Title level={4}>Thông tin về luật sư</Typography.Title>
  ...
  return (
    <div className='flex pt-4'>
      ...
      <div className='ml-8'>
        ...
        <div className='flex mb-4 text-base'>
          <label className='font-semibold text-black mr-1'>Điện thoại:</label>
          <p>{lawyer?.phone}</p>
        </div>
        <div className='flex mb-4 text-base'>
          <label className='font-semibold text-black mr-1'>Email:</label>
          <p>{lawyer?.email}</p>
        </div>
        <div className='flex mb-4 text-base'>
          <label className='font-semibold text-black mr-1'>Website:</label>
          <p>{lawyer?.website}</p>
        </div>
        <Link
