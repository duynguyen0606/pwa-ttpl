    ...
    label: (
      <div>
        ...
        <p className="qa-subdesc">
          Không rõ thời gian tới đây có quy định thế nào về các biện
          pháp khi làm việc với điện cao áp? Nhờ hỗ trợ.
        </p>
      </div>
    ),
    children: (
      <div className="qa-children">
        <h2>Câu trả lời</h2>
        <p>
          Theo Khoản 25 Tiểu mục II.III Mục II Quy chuẩn kỹ thuật quốc
    ...
    <Layout>
      ...
      >
        ...
        >
          ...
          <h2 className="uppercase text-6xl font-semibold pt-4">
            Miễn phí
          </h2>
        </div>
      </div>
