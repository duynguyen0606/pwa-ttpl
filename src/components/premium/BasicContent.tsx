        ...
        <div className="mt-8 mb-16">
            ...
            <div className="mt-4 px-4 flex flex-wrap">
                <ul className="grid grid-cols-2 gap-3 list-disc">
                    ...
                    <li>
                        Hiển thị KPI, hiện % của KPI, &nbsp;hiện phiếu lương,
                        hiển thị nghỉ phép
                    </li>
                    <li>
                        Hiển thị thủ tục hành chính : Tab thủ tục, có thể xem
                        thực tế thực hiện, xem lược đồ, &nbsp;hiển thị tab lĩnh
                        vực, tab đối tượng thực hiện, cơ cấu tổ chức, xem chi
                        tiết cơ cấu tổ chức
                    </li>
                    <li>
                        Hiện khách hàng, hiển thị Chăm sóc khách hàng, hiện thị
                        sự kiện
                    </li>
                    ...
                    <li>
                        Cài đặt quyền cho quy trình : có thể tạo quy trình, hiển
                        thị khách hàng. Hiển thị lịch sử hoạt động, thông tin
                        tiến độ
                    </li>
                    <li>
                        Hiển thị tài liệu, hiển thị bình luận, hiển thị khách
                        hàng nhận xét
                    </li>
                    <li>
                        Hiển thị các bước thực hiện, thêm các bước thực hiện,
                        tạo nhiệm vụ, có thể comment trên nhiệm vụ
                    </li>
                    <li>
                        Cài đặt quyền cho tài chính : hiển thị tài chính , hiển
                        thị hoá đơn, xem chi tiết hoá đơn, có thể thêm mới hoá
                        đơn, tải xuống hoá đơn, có thể thêm thanh toán, hiển thị
                        chi phí, hiển thị báo giá
                    </li>
                    <li>
                        Cài đặt quyền cho Chăm sóc khách hàng : hiển thị chăm
                        sóc khách hàng, cho phép thêm yêu cầu hỗ trợ khách hàng,
                        cho phép thay đổi trạng thái yêu cầu hỗ trợ khách hàng,
                        và xem chi tiết chăm sóc khách hàng
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        duyệt , hiển thị tất cả các ngày nghỉ phép
                    </li>
                    <li>
                        Cài đặt quyền cho thông báo : xem chi tiết thông báo
                    </li>
