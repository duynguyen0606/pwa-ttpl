...
const dataPremium = [
  ...
  },
  {
    id: 4,
    title:
      'Thành viên LGZ DIAMON được nhận các quyền lợi của thành viên LGZ PRO 1 và thêm',
    bgColor: '#83C340',
    name: 'LGZ Diamond',
    promotional_price: 0,
    cost: 510000,
...
function PremiumPage() {
  ...
  return (
    <>
        ...
        <Row gutter={16}>
          {dataPremium.map((item) => (
            ...
            >
              ...
              <div
                style={{
                  color: activeTab === item.id ? 'black' : '#A1A5AC',
                }}
      ...
      >
        <div className='font-medium text-lg'>Bài viết được xem nhiều nhất</div>
