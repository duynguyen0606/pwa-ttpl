...
import ProfileFollowComp from '@/src/components/mobile/user/ProfileFollowComp';
    ...
    if (activeTab === 1) {
      ...
      return (
        <div className='bg-white'>
          ...
          {childTab === 1 && (
            <ProfileFollowComp layout='grid' dataList={listFollower} />
          )}

          {childTab === 2 && (
            <ProfileFollowComp layout='grid' dataList={listFollowing} />
          )}
        </div>
      );
    }
